                 ...
                 div(class = "info-box",
                     ...
                     tags$details(
                       ...
                       tags$ul(
                         ...
                         tags$li("若允许放弃投资，且两个方案 NPV 均 < 0，则不投资严格更优；若最高 NPV = 0，则与不投资无差异；若题目要求必须二选一，则选择 NPV 较高者。"),
                         tags$li("临界折现率是两方案 NPV 曲线的交点，可能不存在或多个。临界折现率只表示两个方案相对优势发生转换，不等于项目是否值得投资的阈值。图中只标出搜索范围内的交点。")
                       )
                     ),
                     tags$hr(),
                     h4("核心教学目标"),
